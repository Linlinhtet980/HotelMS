...
<div class="form-container">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fa-solid fa-calendar-check"></i> Edit Reservation #{{ $booking->id }}
            </h3>
        </div>
        <div class="card-body">
            <form action="{{ route('bookings.update', $booking->id) }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group @error('customer_name') has-error @enderror">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{ old('customer_name', $booking->customer_name) }}" placeholder="Full Name" required>
                        </div>
                        @error('customer_name')
                    ...
                    <div class="form-group @error('customer_phone') has-error @enderror">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" class="form-control" id="customer_phone" name="customer_phone" value="{{ old('customer_phone', $booking->customer_phone) }}" placeholder="09xxxxxxxxx" required>
                        </div>
                    ...
                    <div class="form-group @error('check_in_date') has-error @enderror">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="date" class="form-control" id="check_in_date" name="check_in_date" onchange="calculatePrice()" value="{{ old('check_in_date', $booking->check_in_date->format('Y-m-d')) }}" required>
                        </div>
                        @error('check_in_date')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group @error('check_out_date') has-error @enderror">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="date" class="form-control" id="check_out_date" name="check_out_date" onchange="calculatePrice()" value="{{ old('check_out_date', $booking->check_out_date->format('Y-m-d')) }}" required>
                        </div>
                ...
                <div class="summary-card">
                    <div class="summary-title">
                        <i class="fa-solid fa-file-invoice-dollar"></i> Price Summary (Updated)
                    </div>
                    ...
                    <div class="summary-item total-row">
                        ...
                        <span class="value" id="summary-total">${{ number_format($booking->total_price, 2) }}</span>
                    </div>
...
<script>
    ...
    // Initial run to show current data
